...
namespace Tonic {
  ...
  inline ControlEquals operator == (ControlGenerator lhs, ControlGenerator rhs){
    ControlEquals c;
    c.setLeft(lhs);
    c.setRight(rhs);
    return c;
  ...
  inline ControlEquals operator == (ControlGenerator lhs, TonicFloat right){
    ControlEquals c;
    c.setLeft(lhs);
  ...
  inline ControlNotEquals operator != (ControlGenerator lhs, ControlGenerator rhs){
    ControlNotEquals c;
    c.setLeft(lhs);
    c.setRight(rhs);
    return c;
  ...
  inline ControlNotEquals operator != (ControlGenerator lhs, TonicFloat right){
    ControlNotEquals c;
    c.setLeft(lhs);
    c.setRight(ControlValue(right));
    return c;
  ...
  inline ControlGreaterThan operator > (ControlGenerator lhs, ControlGenerator rhs){
  ...
  inline ControlGreaterThan operator > (ControlGenerator lhs, TonicFloat right){
    ControlGreaterThan c;
    c.setLeft(lhs);
    c.setRight(ControlValue(right));
    return c;
  ...
  inline ControlGreaterOrEqual operator >= (ControlGenerator lhs, ControlGenerator rhs){
  ...
  inline ControlGreaterOrEqual operator >= (ControlGenerator lhs, TonicFloat right){
    ControlGreaterOrEqual c;
    c.setLeft(lhs);
    c.setRight(ControlValue(right));
    return c;
  ...
  inline ControlLessThan operator < (ControlGenerator lhs, ControlGenerator rhs){
    ControlLessThan c;
    c.setLeft(lhs);
    c.setRight(rhs);
    return c;
  ...
  inline ControlLessThan operator < (ControlGenerator lhs, TonicFloat right){
    ControlLessThan c;
    c.setLeft(lhs);
    c.setRight(ControlValue(right));
    return c;
  ...
  inline ControlLessOrEqual operator <= (ControlGenerator lhs, ControlGenerator rhs){
  ...
  inline ControlLessOrEqual operator <= (ControlGenerator lhs, TonicFloat right){
    ControlLessOrEqual c;
    c.setLeft(lhs);
    c.setRight(ControlValue(right));
    return c;
